...
export const userCoinsSelector = (state: AppState) => state.user.data.user.coins;
export const userEnergySelector = (state: AppState) => state.user.data.user.energy;
export const userReferrerSelector = (state: AppState) => state.user.meta.referrerId;
...
export const userPassiveIncomeSelector = (state: AppState) => state.user.data.passiveIncome;
export const userIsLoadingSelector = (state: AppState) => state.user.meta.isLoading;
