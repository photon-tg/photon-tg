...
export const operationClaimReferrals = createAction(
	'operation:user/referrals/claim',
);
export const operationClaimTask = createAction<ClaimTaskPayload>(
	'operation:user/tasks/claim',
);
export const operationPayPassiveIncome = createAction(
	'operation:user/passiveIncome/pay',
);
export const operationRestorePassiveEnergy = createAction(
	'operation:user/energy/restore',
);
export const operationUploadPhoto = createAction<string>(
